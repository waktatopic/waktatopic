	...
	})(
		{
			...
			4: [
				function (b, c, d) {
					function e(a, b) {
						...
						if (
							((b = b || {}),
							b.logging && ((r.options.logging = !0), (r.options.start = Date.now())),
							...
							(b.javascriptEnabled =
								"undefined" == typeof b.javascriptEnabled ? !1 : b.javascriptEnabled),
					...
					function f(a, b, c, d, e) {
						return t(a, a, c, d, b, a.defaultView.pageXOffset, a.defaultView.pageYOffset).then(function (
							f
						) {
							r("Document cloned");
							var h = w + e,
							...
							return (
								(d =
									"view" === c.type
										...
										: a === f.document.body || a === f.document.documentElement || null != c.canvas
										? t.canvas
										: i(t.canvas, {
					...
					function i(a, b) {
						...
						var h = e - d,
							i = g - f;
						return (
							r("Cropping canvas at:", "left:", b.left, "top:", b.top, "width:", h, "height:", i),
			...
			12: [
				function (a, b, c) {
					...
					(d.prototype = Object.create(e.prototype)),
						(d.REGEXP_DIRECTION = /^\s*(?:to|left|right|top|bottom|center|\d{1,3}(?:\.\d+)?%?)(?:\s|$)/i),
						(b.exports = d);
				},
				...
				function (a, b, c) {
					...
					function I(a) {
						return (
							...
							-1 === ["SCRIPT", "HEAD", "TITLE", "OBJECT", "BR", "OPTION"].indexOf(a.node.nodeName)
						);
					}
					function J(a) {
					...
					(d.prototype.calculateOverflowClips = function () {
						...
						(d.prototype.paintText = function (a) {
							...
							this.renderer.font(
								...
								g.length
									? this.renderer.fontShadow(g[0].color, g[0].offsetX, g[0].offsetY, g[0].blur)
			...
			16: [
				function (a, b, c) {
					...
					function h(a, b, c) {
						return (
							a + "?url=" + encodeURIComponent(b) + (c.length ? "&callback=html2canvas.proxy." + c : "")
						);
					}
					function i(a) {
						return function (b) {
				...
				function (a, b, c) {
					...
					(d.prototype = Object.create(f.prototype)),
						(d.prototype.setFillStyle = function (a) {
							return (
								(this.ctx.fillStyle = "object" == typeof a && a.isColor ? a.toString() : a), this.ctx
							);
						}),
